# Requirements: AI Bookmark Manager
...
- [ ] **PROXY-02**: El servidor exposa un endpoint HTTP local (`localhost:PORT`) que accepta peticions d'AI i les envia a l'Anthropic API
